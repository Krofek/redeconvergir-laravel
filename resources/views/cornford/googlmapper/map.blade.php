...
<script type="text/javascript">
	...
	function initialize_{!! $id !!}() {
		...
		{{--@if (isset($options['eventDragEnd']))--}}
			{{--map_{!! $id !!}.addListener('dragend', function(){--}}
				{{--{!! $options['eventDragEnd'] !!}(map_{!! $id !!}.getBounds())--}}
			{{--});--}}
		{{--@endif--}}

		{{--@if (isset($options['eventZoomChanged']))--}}
			{{--map_{!! $id !!}.addListener('zoom_changed', function(){--}}
				{{--{!! $options['eventZoomChanged'] !!}(map_{!! $id !!}.getBounds())--}}
			{{--});--}}
		{{--@endif--}}
